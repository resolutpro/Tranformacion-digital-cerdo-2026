...
export default function DistribucionPage() {
  ...
  const { data: zones = [], isLoading } = useQuery<Zone[]>({
    queryKey: ["/api/zones", { stage: "distribucion" }],
    queryFn: async () => {
      const res = await apiRequest("GET", "/api/zones?stage=distribucion");
      return res.json();
    }
  });
  ...
  const createZoneMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Zona creada",
        description: "La zona de distribución ha sido creada correctamente",
      });
    ...
    <MainLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-foreground mb-2">Distribución</h1>
            <p className="text-muted-foreground">Gestiona las zonas de almacenamiento y distribución final</p>
          </div>
          <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Crear Nueva Zona de Distribución</DialogTitle>
              </DialogHeader>
              <form onSubmit={handleCreateZone} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ej: Almacén Principal, Cámara Fría, etc."
                    required
          ...
          {isLoading ? (
            ...
            <Card className="col-span-full">
              <CardContent className="text-center py-12">
                <p className="text-muted-foreground mb-4">No hay zonas de distribución creadas</p>
